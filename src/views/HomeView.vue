  ...
  <v-container style="text-align: center;">
    <v-row>
      ...
      <v-col cols="12">
        ...
        />
        <!-- 只有倒數中才能按暫停 -->
        <v-btn :disabled="status !== STATUS.COUNTING" icon="mdi-pause" @click="pause" style="background: #73A0EB;" />
        <!-- 目前有事項才能跳過 -->
        <v-btn :disabled="list.currentItem.length === 0" icon="mdi-skip-next" @click="finish"style="background: #73A0EB;" />
      </v-col>
    </v-row>
  </v-container>
</template>
